...
$(document).ready(function () {
  ...
  new Typed(".about-description", {
    strings: [
      `We are best Bussiness Services agency in Egypt We are OMEGA and we are the biggest agency of advertising in egypt. Please checkour studio for more information, and <a href="#contact-us">contact page</a> to hiring a jobs.`,
    ],
    typeSpeed: 20,
    showCursor: false,
  });
